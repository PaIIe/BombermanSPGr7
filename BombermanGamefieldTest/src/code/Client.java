...
public class Client{
	...
	private ClientListener clientListener;
        //verbindt Server und Information empfangen
                        ...
                        public void run(){
                            while(open){
                                try{
                                    ...
                                    //Client liest die Information von Server wenn "open"
                                    if(s==null){
                                        //die Information von Server ist leer
                                        open=false;
	...
	public void dispose(){
            //Wenn alles Verbindung abbrecchenen,release the source.
		try{
			if(open){
				open=false;
				socket.close();
